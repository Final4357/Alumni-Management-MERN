...
const PostedJobs = () => {
  ...
  }, [showModal, update, createdJobPageNo])
        ...
        <div className='bg-slate-100 py-2 gap-3 flex flex-col lg:flex-row lg:items-center justify-between'>
          ...
          <div class=" flex items-center ">
            <div class="w-[264px] sm:w-96 relative">
              ...
              <input type="search" id="voice-search" class="pl-10 bg-slate-100  border border-gray-300 text-gray-800 text-sm rounded-lg focus:ring-[#2C1654] focus:border-[#2C1654] block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Company, Position" required />
            </div>
          </div>
        </div>
        {Jobs.map((item, i) => {
