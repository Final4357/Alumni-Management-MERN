                        ...
                        <ul class="space-y-2 text-sm mt-3">
                            ...
                            <li>
                                <a
                                    ...
                                    href="/"
                                >
                                    <span class="text-gray-700">Alumni Center</span>
                                </a>
                            </li>
                    ...
                    <div class="text-sm flex flex-col-reverse space-y-3 lg:space-y-0 lg:flex-row gap-5 lg:gap-0 justify-between items-center text-gray-500 ">
                        <div >
                            <p class="mt-4 text-sm text-gray-500 sm:order-first  sm:mt-0" style={{ margin: 0 }}>
                                &copy; International Islamic University Chittagong.
                            </p>
                            <div>Kumira, Chattogram-4318</div>
                        </div>
                        <div className='flex flex-col gap-4'>
                            ...
                            <ul className='flex flex-wrap justify-center lg:justify-end gap-4'>
                                ...
                                <li><Link to='' className='text-md font-medium hover:underline'>Privacy</Link></li>
                                <li><Link to='' className='text-md font-medium hover:underline'>Accessibility</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
