...
const Homepage = () => {
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="w-full">
      <h1 className="mb-5 text-5xl font-semibold">IIUC Alumni</h1>
      <h1 className="mb-5 text-8xl font-extrabold">Welcome Home</h1>
      <h1 className="mb-5 text-4xl font-semibold">IIUC Alumni Association helps you keep IIUC close wherever you are.</h1>
